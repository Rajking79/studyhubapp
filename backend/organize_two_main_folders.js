...
function buildUrl(pathStr) {
  ...
  return {
    raw: `http://localhost:5000/api/v1/${pathStr}`,
    host: ["{{baseUrl}}"],
...
const collection = {
  info: {
    _postman_id: "studyhub-clean-2-folder-suite-2026",
    name: "StudyHub Master REST API Suite (App & Admin Clean Split)",
    description: "Super Clean Postman Collection cleanly split into 2 Main Top-Level Folders: Mobile App APIs and Admin Control Panel APIs.",
  ...
  item: [
    {
      name: "📱 1. StudyHub Mobile App APIs",
      item: [
        {
    ...
    {
      name: "⚡ 2. StudyHub Admin Control Panel APIs",
      item: [
        {
...
console.log('✅ Clean 2-Main-Folder Postman Collection JSON Generated Successfully!');
