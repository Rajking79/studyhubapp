...
router.get("/activity-logs", authenticate, verifyAdmin, adminController.getAuditLogs);
...
router.get("/students", authenticate, verifyAdmin, adminController.getUsers);
router.post("/notifications/send", authenticate, verifyAdmin, adminController.sendNotification);
router.post("/notifications/broadcast", authenticate, verifyAdmin, adminController.sendNotification);
...
router.get("/feedback", authenticate, verifyAdmin, adminController.getFeedbacks);
